    ...
    <div class="container">
        ...
        <div class="card">
            <div class="customer-profile">                
                <!--<img src="{{ asset('storage/customers/' . $cliente->image ) }}">-->
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!--En este caso producto corresponde a la entidad/tabla presentaciones-->
                            @if($detalle->product)
                        ...
                        <td>
                            @if($detalle->product && $detalle->product->category)
