...
<div class="accordion" id="customersAccordion">
    ...
    <div class="card">
        <div class="card-header" id="customersHeading">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#customersCollapse"
                    aria-expanded="false" aria-controls="customersCollapse">
                    <h3>CLIENTES</h3>
                </button>
            </h2>
        </div>

        <div id="customersCollapse" class="collapse show" aria-labelledby="customersHeading"
                        ...
                        <div class="card-header" id="customerHeading{{ $index }}">
                            <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                    data-target="#customerCollapse{{ $index }}" aria-expanded="true"
                                    aria-controls="customerCollapse{{ $index }}">
                                    <h3>{{ $customer->DisplayName }}</h3>
                                </button>
                            </h2>
                        </div>

                        <div id="customerCollapse{{ $index }}" class="collapse @if ($index === 0) show @endif"
                            aria-labelledby="customerHeading{{ $index }}" data-parent="#customerAccordion">
                            <div class="card-body">
...
<div class="accordion" id="invoicesAccordion">
    <div class="card">
        <div class="card-header" id="invoicesHeading">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#invoicesCollapse"
                    aria-expanded="true" aria-controls="invoicesCollapse">
                    <h3>FACTURAS</h3>
                </button>
            </h2>
        </div>
        <div id="invoicesCollapse" class="collapse show" aria-labelledby="invoicesHeading"
            data-parent="#invoicesAccordion">
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mt-1">
                        <thead class="text-white" style="background: #FF5100;">
                            <tr>
                                ...
                                <th class="table-th text-white text-center">Estado de Pago</th>
                        ...
                        <tbody>  
                            ...
                            @foreach ($invoicesNew as $invoice)
                                <tr>
                                    ...
                                    <td class="table-th text-center">{{ $invoice->CustomerName }} </td>
                                    <td class="table-th text-center">${{ $invoice->TotalAmt }}</td>
                                    <td class="table-th text-center">${{$invoice->Balance}} 
...
<div class="accordion" id="paymentsAccordion">
    ...
    <div class="card">
        <div class="card-header" id="paymentsHeading">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#paymentsCollapse"
        ...
        <div id="paymentsCollapse" class="collapse show" aria-labelledby="paymentsHeading"
...
<div class="accordion" id="suppliersAccordion">
    ...
    <div class="card">
        <div class="card-header" id="suppliersHeading">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#suppliersCollapse"
                    aria-expanded="true" aria-controls="suppliersCollapse">
                    <h3>PROVEEDORES</h3>
                </button>
            </h2>
        </div>

        <div id="suppliersCollapse" class="collapse show" aria-labelledby="suppliersHeading"
            data-parent="#suppliersAccordion">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mt-1">
                        <thead class="text-white" style="background: #FF5100;">
