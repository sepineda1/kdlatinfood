<div wire:ignore.self class="modal fade" id="modalDetails" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark d-flex justify-content-left ">
                    ...
                    <table class="table table-bordered table striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <h6>{{$d->product_name}} {{$d->size_name}} </h6>
                                </td>
                                <td class='text-center'>
                                    <h6>{{ $d->product_estado }}</h6>
                                </td>
                                <td class='text-center'>
            ...
            <div class="modal-footer">
                ...
                <button style="background: #FF5100"
                    class="btn  mb-2 mr-2 btn-rounded text-white"
                    onclick="loader();Livewire.emit('openEditModal', {{$saleId}})"
                >
