                        ...
                        <table class="table table-bordered table-striped mt-1">
                            <thead class="text-white" style="background: #3B3F5C">
                                <tr>
									...
									<th class="table-th text-center text-white">DISCOUNT</th>
									<th class="table-th text-center text-white">DISCOUNTED PRICE</th>
                            ...
                            <tbody>
								...
								@php 
									$discount = $d->discount > 0 ? ($d->price * $d->discount)/100 : 0;
									$discountedPrice = number_format($d->price - $discount, 2); 
									$total = number_format($discountedPrice * $d->quantity, 2);
									$SumaTotal += $total;
								@endphp
                                <tr>
									...
									<td class="text-center"><h6>{{$d->discount}}%</h6></td>
									<td class="text-center"><h6>${{$discountedPrice}}</h6></td>
                            ...
                            <tfoot>
								...
								<td></td>
								<td></td>
                            	<td class="text-center"><h6 class="text-info">${{number_format($SumaTotal,2)}}</h6></td>
                            	@endif
                            </tfoot>
                        </table>
                    </div>
