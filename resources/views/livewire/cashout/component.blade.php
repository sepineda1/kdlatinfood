                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3 align-self-center d-flex justify-content-around">
                        @if ($userid > 0 && $fromDate != null && $toDate != null)
                            <button wire:click.prevent="Consultar" type="button" class="btn btn-dark">CONSULT</button>
                        @endif

                        @if ($total > 0)
                            <button wire:click.prevent="Print()" type="button" class="btn btn-dark">PRINT</button>
                        @endif
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        <h5 class="text-white">Total Venta: ${{ number_format($total, 2) }}</h5>
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            ...
                            <tbody>
                                @if ($total <= 0)
                                    <tr>
                                        <td colspan="4">
                                            <h6 class="text-center">No SALES</h6>
                                        </td>
                                    </tr>
                                @endif
