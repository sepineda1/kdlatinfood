			...
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills">		
					...
					<li>
						...
						>Add</a>
						<button class="btn btn-dark mb-2 btn-rounded d-none" onclick="imprimir()">Imprimir Ticket</button>

<script>
	function imprimir() {
		window.print(); // Activa el diálogo de impresión
	}
</script>
					</li>	
					@endcan
...
<script>
	...
	function filterCategories() {
        ...
        tableRows.forEach(row => {
            let categoryName = row.querySelector("td h6").textContent.toLowerCase();
