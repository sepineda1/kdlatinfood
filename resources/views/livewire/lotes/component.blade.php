                ...
                <ul class="tabs tab-pills">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="tabmenu bg-dark" data-toggle="modal"
                            data-target="#theModal">Add Lot</a>
                    </li>
                ...
                <div id="accordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="heading{{$cat->id}}">
                            <h3 class="mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$cat->id}}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped  mt-1">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                            @foreach($data as $lot)
                                            @if ($lot->presentacion->category_id == $cat->id && $lot->estado == "Normal")
                                            @php
                                            $hasLots = true;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <h6>{{$lot->presentacion->barcode}}</h6>
                                                </td>
                                                <td class="text-center">
                                                    <h6>{{$lot->presentacion->product->name}}</h6>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    @role('Admin|Employee')
                                                    <a style="background:#f39022;" href="javascript:void(0)"
                                                        onclick="Cambio('{{$lot->id}}')" class="btn btn-dark mtmobile"
                                                        title="Cambio">
                                                        <i class="fas fa-upload"></i>
                                                    </a>
                                                    <a class="btn btn-dark"
                                                        href="{{ url('detail/pdf' . '/' . $lot->id ) }}" title="print"
                                                        target="_blank" style="background:#f39022;"> <i
                                                            class="fas fa-print"></i></a>

                                                    @endcan
                                                    @role('Admin')
                                                    <a style="background:#f39022;" href="javascript:void(0)"
                                                        onclick="Confirm('{{$lot->id}}')" class="btn btn-dark mtmobile"
                                                        title="Delete">
