			...
			<div class="modal-body">
				...
				<div class="col-sm-12 col-md-5">
					<div class="form-group">
						...
						<input type="text" wire:model.lazy="CodigoBarras" name="CodigoBarras" class="form-control"
							placeholder="Generating CodeBar.." disabled wire:loading.attr="disabled" id="CodigoBarras"
							x-data="{barcodePlaceholder: 'Generating CodeBar..'}" x-init="Livewire.on('CodigoBarras-generated',CodigoBarras=>{
				...
				<div class="col-sm-12 col-md-6">
					<div class="form-group">
						...
						<input type="date" wire:model.lazy="Fecha_Vencimiento" class="form-control" value="{{ $fecha }}"
							readonly>
