<div>
        ...
        <div class="col-sm-12">
            <div class="widget widget-chart-one">
                <div class="widget-heading">
                    <h4 class="card-title">
                        <b>Lots de insumo | Materia Prima</b>
                    </h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <h6> @if($lot->peso != "Libras") {{$lot->convertirPeso($lot->peso,$lot->Cantidad_Articulos )}} {{$lot->peso}} / @endif  {{$lot->Cantidad_Articulos}} Libras</h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <h6>{{ \Carbon\Carbon::parse($lot->Fecha_Vencimiento)->format('d-m-Y')}}
                                                        </h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <h6>{{ \Carbon\Carbon::parse($lot->created_at)->format('d-m-Y')}}
                                                        </h6>
                                                    </td>
                                                    <!--     <td class="text-center">
                                        @role('Admin|Employee')
    ...
    searchInput.addEventListener('input', function () {
        ...
        // Obtener todas las tarjetas de los sabores
        const cards = document.querySelectorAll('.card');

        cards.forEach(card => {
            const title = card.querySelector('.card-header button').textContent.toLowerCase();
            ...
            if (tbody) {
                ...
                if (!hasMatch) {
                    if (!noResultsRow) {
                        ...
                        tr.innerHTML = `<td colspan="4" class="text-center"><h6>No se encontraron resultados</h6></td>`;
            ...
            // Ocultar o mostrar la tarjeta completa según el título o el contenido de la tabla
            if (title.includes(searchTerm) || hasMatch) {
                card.style.display = '';
            } else {
