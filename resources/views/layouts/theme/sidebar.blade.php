...
<div class="container1 ">
    ...
    <div class="sidebar-wrapper sidebar-theme">
                    ...
                    <a href="#inspectors" data-active="false" class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-git-merge">
        ...
        <div id="compact_submenuSidebar" class="submenu-sidebar ps"
            style="  background-color: white;  backdrop-filter: blur(30px);">

            <div class="submenu" id="dashboard" style="backdrop-filter: blur(10px);">
                <ul class="submenu-list" data-parent-element="#dashboard">
                @role('Admin|Employee')
                    <li>
                        <a href="{{ url('products') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                    ...
                    <a href="{{ url('presentaciones') }}" style="color: #e84039;"><svg style="color: #e84039;" viewBox="0 0 24 24" width="24"
                                ...
                                <rect x="14" y="14" width="7" height="7"></rect>
                                <rect x="3" y="14" width="7" height="7"></rect>
                            </svg> Presentaciones </a>
                    </li>
                    <!-- <li>
                        <a href="{{ url('presentaciones') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                                fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <path
                                    d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z">
                    ...
                    @role('Admin')
                    <li>
                        <a href="{{ url('insumos') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                                fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                            ...
                            </svg> Lotes de Materia Prima</a>
                    </li>
                    @endcan
                    @role('Admin|Employee')
                    <li>
                        <a href="{{ url('lotes') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                                fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <ellipse cx="12" cy="5" rx="9" ry="3"></ellipse>
                                <path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path>
                                <path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path>
                            </svg>Lotes de Productos </a>
                    </li>
                    @endcan
                    @role('Admin')
                    <li>
                        <a href="{{url('despachos')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                                fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <polygon points="3 11 22 2 13 21 11 13 3 11"></polygon>
                            </svg> Entregas </a> <!--Deliveries --->
                    </li>
                    <li>
                        <a href="{{ url('pos') }}" style="color: #e84039;"><svg style="color: #e84039;"
            ...
            <div class="submenu" id="inspectors">
                ...
                @role('Admin')
                    <li>
                        <a href="{{ url('inspectors') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                     ...
                     {{--   <a href="{{ url('quickbooks')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{url('cashout')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2"
                                fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <line x1="12" y1="1" x2="12" y2="23"></line>
                                <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
            ...
            <div class="submenu" id="Despachos">
                <ul class="submenu-list" data-parent-element="#Despachos">
                    ...
                    <li>
                        <a href="{{url('envios')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="submenu show" id="app">
                ...
                @role('Admin')
                    <li>
                        <a href="{{url('clientes')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{url('categories')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{ url('sabores') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{ url('sizes') }}" style="color: #e84039;"><svg style="color: #e84039;" viewBox="0 0 24 24" width="24"
                                height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" class="css-i6dzq1">
                                <rect x="3" y="3" width="7" height="7"></rect>
                                <rect x="14" y="3" width="7" height="7"></rect>
                    ...
                    @role('Admin|Accountant')
                    <li>
                        <a href="{{url('reports')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    @role('Admin')
                    <li>
                        <a href="{{url('transportes')}}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    @role('Admin')
                    <li>
                        <a href="{{ url('roles') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{ url('users') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    @role('Admin|Accountant')
                    <li>
                        <a href="{{ url('coins') }}" style="color: #e84039;"><svg style="color: #e84039;"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
{{-- 
                    @role('Admin')
                    <li>
                        <a href="{{url('maps')}}" style="color: #e84039;">
                            <svg style="color: #e84039;" viewBox="0 0 24 24" width="24"
                                height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" class="css-i6dzq1">
                                <rect x="3" y="3" width="7" height="7"></rect>
                                <rect x="14" y="3" width="7" height="7"></rect>
